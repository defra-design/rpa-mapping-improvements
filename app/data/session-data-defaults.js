module.exports = {
  // OS Vector tile API
  VTS_OUTDOOR_URL: process.env.VTS_OUTDOOR_URL,
  VTS_DARK_URL: process.env.VTS_DARK_URL,
  VTS_BLACK_AND_WHITE_URL: process.env.VTS_BLACK_AND_WHITE_URL,
  VTS_SATELLITE_URL: process.env.VTS_SATELLITE_URL,
  // OS Names API 

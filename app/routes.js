...
router.post("/parcel-is-not-registered", function (req, res) {
  res.redirect("upload-land-parcel-map");
});

router.post("/upload-land-parcel-map", function (req, res) {
  res.redirect("date-to-link-parcel-to-business");
});
...
router.post("/parcel-is-new", function (req, res) {
  res.redirect("upload-land-parcel-map");
});

router.post("/estimate-parcel-ID", function (req, res) {
  res.redirect("parcel-is-new");
});

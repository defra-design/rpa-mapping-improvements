...
router.post('/download-maps-v6/demo-start', function (req, res) {
  ...
  res.redirect('/download-maps-v6/start');
});

// Main map page
router.post('/download-maps-v6/get-maps-of-your-land-tabs', function (req, res) {
  ...
  res.redirect('/download-maps-v6/map-pack-contents');
});

router.post('/download-maps-v6/get-maps-of-your-land', function (req, res) {
...
router.post('/download-maps-v6/get-maps-of-your-land-poc-4', function (req, res) {
...
router.post('/download-maps-v6/get-maps-of-your-land-poc-5', function (req, res) {
  // Data is automatically saved to session by the prototype kit
  // via req.session.data (from form fields)
...
router.post('/download-maps-v6/rename-option-a', function (req, res) {
...
router.post('/download-maps-v6/rename-option-b', function (req, res) {
...
router.post('/download-maps-v6/rename-option-c', function (req, res) {
...
// Layout debug page
router.post('/download-maps-v6/get-maps-of-your-land-layout', function (req, res) {
  res.redirect('/download-maps-v6/map-pack-contents');
});

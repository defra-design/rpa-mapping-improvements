...
router.post("/register-land-v1/parcel-registered", function (req, res) {
...
router.post("/register-land-v1/know-parcel-id", function (req, res) {
...
router.post("/register-land-v1/enter-parcel-id", function (req, res) {
...
router.post("/register-land-v1/parcel-is-registered", function (req, res) {
  res.redirect("date-to-link-parcel-to-business");
});

router.post("/register-land-v1/date-to-link-parcel-to-business", function (req, res) {
...
router.post("/register-land-v1/check-parcel-details", function (req, res) {
...
router.post("/register-land-v1/register-land-declaration", function (req, res) {
  res.redirect("register-land-confirmation");
});

router.post("/register-land-v1/parcel-is-not-registered", function (req, res) {
  res.redirect("upload-land-parcel-map");
});

router.post("/register-land-v1/upload-land-parcel-map", function (req, res) {
  res.redirect("date-to-link-parcel-to-business");
});
...
router.post("/register-land-v1/find-parcel-id", function (req, res) {
...
router.post("/register-land-v1/parcel-is-new", function (req, res) {
  res.redirect("upload-land-parcel-map");
});

router.post("/register-land-v1/estimate-parcel-ID", function (req, res) {
  res.redirect("parcel-is-new");
});

router.post("/register-land-v1/check-if-parcel-id-registered", function (req, res) {
  if (req.session.data["foundParcelID"] == "TL4257 0684") {
    res.redirect("parcel-is-registered");
  } else {
    res.redirect("parcel-is-not-registered");

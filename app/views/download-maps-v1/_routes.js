...
// What type of map
router.post("/download-maps-v1/what-maps", function (req, res) {
...
// Load parcel id data
router.get("/download-maps-v1/select-land-parcels-to-print", function (req, res) {
  res.render("download-maps-v1/select-land-parcels-to-print", {
    tableData: tableData
  });
});

// Handle parcel selection
router.post("/download-maps-v1/select-land-parcels-to-print", function (req, res) {
...
router.post("/download-maps-v1/information-to-display-on-maps", function (req, res) {
  res.redirect("download-maps");
});

router.get("/download-maps-v1/download-maps", function (req, res) {
  const selectedParcels = req.session.data.selectedParcels;
  
  res.render("download-maps-v1/download-maps", {
